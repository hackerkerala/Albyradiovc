...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data == "replay":
        ...
        buttons = [
            [
                InlineKeyboardButton('⚙️ Learn more about Developer', url='https://albinpraveen.ml'),
                InlineKeyboardButton('🤖Ask doubts about the bot', url='https://t.me/i_am_albin_praveen'),
            ],
            [
                InlineKeyboardButton('👨🏼‍💻 Developer', url='https://t.me/i_am_albin_praveen'),
                InlineKeyboardButton('🧩 Source', url='https://github.com/ALBINPRAVEEN/Albyradiovc'),
            ]
            ]
