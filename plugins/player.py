...
async def yplay(_, message: Message):
    ...
    if type=="youtube" or type=="query":
        ...
        try:
            ...
            thumb="https://t.me/musicwithalby/1571"
            pass
...
async def upload(client, message):
    ...
    if playlist[0][3] == "telegram":
        await client.send_audio(chat_id=message.chat.id, audio=url, caption="Uploaded Using [MusicPlayer](https://github.com/ALBINPRAVEEN/Albyradiovc)")
...
async def not_chat(_, m: Message):
    buttons = [
        [
            InlineKeyboardButton('⚡️Source Code', url='https://github.com/ALBINPRAVEEN/Albyradiovc'),
            InlineKeyboardButton('🧩 Developer', url='https://albinpraveen.ml'),
        ],
        [
            InlineKeyboardButton('Deplot your own bot', url='https://heroku.com/deploy?template=https://github.com/ALBINPRAVEEN/Albyradiovc'),
            InlineKeyboardButton('👨🏼‍🦯 Help', callback_data='help')       
        ]
        ]
    k=await m.reply("<b>You can't use this bot in this group, for that you have to make your own bot from the [SOURCE CODE](https://github.com/ALBINPRAVEEN/Albyradiovc) below.</b>", disable_web_page_preview=True, reply_markup=InlineKeyboardMarkup(buttons))
    await mp.delete(m)
